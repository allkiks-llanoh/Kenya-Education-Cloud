                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Search For a  Voucher / School To Update Fund Allocation</h5>
                        </div>
                        <div class="ibox-content">
                                   <input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="Search For a  Voucher / School To Update Fund Allocation">
