    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Voucher Management</span> </a>
                </li>
                ...
                <div class="text-center m-t-lg">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Search For A Voucher / School To Approve or Reject</h5>
                        </div>
                        <div class="ibox-content">
                            <input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="Search For A Voucher / School">
