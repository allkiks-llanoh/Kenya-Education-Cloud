...
function drawRow(rowData) {
    ...
    row.append($(`<td> <a href="/PrincipalCurator/ViewPublication/${rowData.id}?Pub=${rowData.id}&Urls=${rowData.url}" class="btn btn-w-m btn-info" style="background-color:#00B95F;" role="button">Read Curation Recommendations</a>`));
