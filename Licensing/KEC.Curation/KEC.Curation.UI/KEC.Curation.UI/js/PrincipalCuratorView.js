...
let principalCuratorGetUrl = apiBaseUrl.concat(`/PrincipalCurator/PrincipalCurator`)
   ...
   //UnAssigned Table starts here
    ...
    function drawRow(rowData) {
        ...
        row.append($(`<td> <a href="/PrincipalCurator/PrincipalCuratorReview/?Title=${rowData.title}&Identity=${rowData.id}&Publication=${rowData.kicdNumber}&Stage=PrincipalCurator" class="btn btn-w-m btn-info" style="background-color:#00B95F;" role="button">Review</a>`));
