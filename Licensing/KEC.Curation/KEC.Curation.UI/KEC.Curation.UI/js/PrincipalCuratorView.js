...
function drawRow(rowData) {
    ...
    row.append($(`<td> <a href="/PrincipalCurator/PrincipalCuratorReview/?Title=${rowData.title}&Identity=${rowData.id}&Publication=${rowData.kicdNumber}&Urls=${rowData.curationUrl}&Stage=PrincipalCurator" class="btn btn-w-m btn-info" style="background-color:#00B95F;" role="button">Review</a>`));
