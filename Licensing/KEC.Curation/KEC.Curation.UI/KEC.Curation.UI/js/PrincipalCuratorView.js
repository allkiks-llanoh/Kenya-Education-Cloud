...
let principalCuratorGetUrl = apiBaseUrl.concat(`/PrincipalCurator/PrincipalCurator`)
   ...
   //UnAssigned Table starts here
    ...
    function drawRow(rowData) {
        ...
        row.append($(`<td> <a href="/PrincipalCurator/PrincipalCuratorReview/?${rowData.id}&Title=${rowData.title}&Publication=${rowData.kicdNumber}&Stage=PaymentVerification" class="btn btn-w-m btn-info" style="background-color:#00B95F;" role="button">Review</a>`));
