...
let financeGETUrl = apiBaseUrl.concat(`/Publications/1/${_stage}`)
    ...
    function drawRow(rowData) {
        ...
        row.append($(`<td> <a href="/Stages/FinanceVerify/?Title=${rowData.title}&Publication=${rowData.kicdNumber}&Stage=PaymentVerification" class="btn btn-w-m btn-info" role="button">Review</a>`));
