...
namespace KEC.ECommerce.Data.Helpers
{
    public static class RandomCodeGenerator
    {

        public static string GetOrderNumber(string prefix) => $"{prefix}{RandomCode(8)}";
        public static string GetLicenceNumber(string prefix) => $"{prefix}{RandomCode(12)}";
